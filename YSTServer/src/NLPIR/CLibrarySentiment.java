...
public interface CLibrarySentiment extends Library {
	String path = "D://program/eclipse-4.4-workspcae/YSTServer/win64/SentimentNew.dll";
//	String path = "/root/NLPIR_IN_PROJECT/libSentimentNew.so";
	
    CLibrarySentiment Instance = (CLibrarySentiment) Native.loadLibrary(
            path, CLibrarySentiment.class);
